...
function UnionFind(): ReactElement {
  return (
    <>
      ...
      <h2 className="my-2 font-bold">Непересекающиеся множества</h2>
      <p className="mb-2">
      ...
      <h2 className="my-2 font-bold">Начальная настройка</h2>
      <Code value={UNION_FIND_SETUP} />
      <h2 className="my-2 font-bold">Поиск</h2>
      <p className="mb-2">
      ...
      <h2 className="my-2 font-bold">Сжатие пути</h2>
      <p className="mb-2">
      ...
      <h2 className="my-2 font-bold">Объединение</h2>
      <p className="mb-2">
