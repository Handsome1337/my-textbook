...
function Objects(): ReactElement {
  return (
    <>
      <p className="mb-2">
        Объект — это коллекция свойств, состоящая из пар ключ/значение. В других языках
        программирования эту структуру данных также называют хэш-таблицей.{' '}
        <code>Map</code> – это коллекция ключ/значение, как и объект. Но основное отличие
        в том, что <code>Map</code> позволяет использовать ключи любого типа.
      </p>
