...
function OneDimensionDP(): ReactElement {
  return (
    <>
      ...
      <h2 className="my-2 font-bold">Что такое динамическое программирование?</h2>
      <p className="mb-2">
      ...
      <h2 className="my-2 font-bold">Динамическое программирование против рекурсии</h2>
      <p className="mb-2">
      ...
      <h2 className="my-2 font-bold">Метод динамического программирования сверху</h2>
      <p className="mb-2">
